...
try:
    df=pd.read_excel("main_indis_fiyat.xlsx")
    ...
    returns_table.to_excel("indis_profit.xlsx",index=False,engine="openpyxl")
    print("✅ indis_profit.xlsx yazıldı")
except:
    print("❌ indis_profit.xlsx yazılamadı")
